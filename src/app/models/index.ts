...
export interface SeguimientoComercial { tipo_entidad: 'Taller' | 'Tienda de refacciones'; id_entidad:number; estado:string; proxima_accion:string|null; notas:string; asignado_a_mi:boolean; }
