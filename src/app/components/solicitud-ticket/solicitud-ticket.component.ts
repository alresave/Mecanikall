    ...
    <main class="min-h-dvh bg-slate-950 px-5 py-8 text-slate-50 sm:px-8">
      <section class="mx-auto w-full max-w-md">
        <header class="mb-8 flex items-center gap-3">
          <div class="grid size-11 place-items-center rounded-lg border border-slate-700 bg-[#1f2937] shadow-lg shadow-black/20"><img src="logo.png" alt="Mecanikall" class="size-10 object-contain" /></div>
